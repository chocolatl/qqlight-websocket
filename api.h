...
EXTERN const char* __stdcall (*QL_getBkn_Long)(const char* cookies, const char* authCode);
EXTERN const char* __stdcall (*QL_sendQzone)(const char* content, const char* authCode);
