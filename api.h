...
EXTERN const char* __stdcall (*QL_getFriendList)(const char* authCode);
...
EXTERN const char* __stdcall (*QL_getGroupList)(const char* authCode);
EXTERN const char* __stdcall (*QL_getGroupMemberList)(const char* group, const char* authCode);
